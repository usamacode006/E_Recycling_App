...
class DummyFaceCheck extends StatefulWidget {
  @override
  _DummyFaceCheckState createState() => _DummyFaceCheckState();
}

class _DummyFaceCheckState extends State<DummyFaceCheck> {
