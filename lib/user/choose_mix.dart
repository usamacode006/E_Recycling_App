...
import 'choose_general_purpose_water.dart';
import 'choose_water.dart';
import 'home_screen.dart';

double hei = 0;
double wid = 0;

class ChooseMix extends StatefulWidget {
  const ChooseMix({Key? key}) : super(key: key);

  @override
  _ChoooseMixState createState() => _ChoooseMixState();
}

class _ChoooseMixState extends State<ChooseMix> {
