...
class ChoosePaperAndCalculate extends StatefulWidget {
  @override
  _ChoosePaperAndCalculateState createState() =>
      _ChoosePaperAndCalculateState();
}

class _ChoosePaperAndCalculateState extends State<ChoosePaperAndCalculate> {
