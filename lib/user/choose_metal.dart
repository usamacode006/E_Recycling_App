...
class ChooseMetalAndCalculate extends StatefulWidget {
  @override
  _ChooseMetalAndCalculateState createState() =>
      _ChooseMetalAndCalculateState();
}

class _ChooseMetalAndCalculateState extends State<ChooseMetalAndCalculate> {
