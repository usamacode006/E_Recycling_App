...
class ChooseSwimmingPoolWater extends StatefulWidget {
  @override
  _ChooseSwimmingPoolWaterState createState() =>
      _ChooseSwimmingPoolWaterState();
}

class _ChooseSwimmingPoolWaterState extends State<ChooseSwimmingPoolWater> {
                  ...
                  Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          '${context.watch<DetailScreenProvider>().slider_value} CCF',
                          style: TextStyle(
                            fontSize: hei / 47.4,
                        ...
                        customCard(
                          ...
                          () {
                            Navigator.push(context,
                              ...
                              return ChooseGeneralPurposeWater();
                            }));
                          },
                        ),
                        customCard(
