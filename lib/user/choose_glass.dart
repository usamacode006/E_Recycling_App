...
class ChooseGlassAndCalculate extends StatefulWidget {
  @override
  _ChooseGlassAndCalculateState createState() =>
      _ChooseGlassAndCalculateState();
}

class _ChooseGlassAndCalculateState extends State<ChooseGlassAndCalculate> {
                ...
                child: ElevatedButton(
                  onPressed: () async{
                    ...
                    await FirebaseFirestore.instance
                        ...
                        .doc('GLASS')
                        .update({
                      'weight': context.read<DetailScreenProvider>().slider_value
                    });
